...
measureFileHandle.write("Parameter=#ROOTCONFIGPATH#/PythonEXEs/multipleServerPingChecker.exe -i \"../ServersToPing.ini\" -c #serverConnCheckInterval# -p #ROOTCONFIGPATH#/PingFiles/CheckServerConnectivity/\n")
